...
description: "Common issues and solutions for Agentflare Telepathy"
icon: "wrench"
...
<AccordionGroup>
  <Accordion title="Tool Calls Not Appearing in Dashboard" icon="eye-slash">
    **Symptoms:**
    ...
    - No data appears in Telepathy dashboard
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/agentflare-ai/agentflare/issues">
