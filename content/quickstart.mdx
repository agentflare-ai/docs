...
```
https://<your-server-slug>.proxy.agentflare.com
```
...
<Tabs>
  <Tab title="IDE/Agent Platform">
    Using an AI IDE like Claude Desktop, Cursor, Cline, or Windsurf?

    See our comprehensive platform integration guide:

    <Card
      title="Agent Platform Setup Guide"
      icon="puzzle-piece"
      href="/content/agent-integration"
    >
      Step-by-step guides for Claude Desktop, Cursor, Cline, Windsurf, and Continue.dev
    </Card>

    **Quick Summary:**
    1. Find your platform's MCP configuration file
    2. Add your Agentflare proxy URL and API key
    3. Restart your IDE/platform
    4. Verify tools are available

    Each platform has specific configuration file locations and formats. Follow the detailed guide for your platform.
  </Tab>
  ...
  <Tab title="Standard MCP Client">
    ...
    client = Client(
        transport=HTTPTransport(
            base_url="https://<server-slug>.proxy.agentflare.com",
            headers={
