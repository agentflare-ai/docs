...
description: "Definitions of key terms and concepts in Agentflare"
icon: "book"
keywords: ["glossary", "definitions", "terminology", "MCP", "Model Context Protocol", "Agentflare", "observability", "AI agents"]
---
...
**In Agentflare:** The early access program provides priority access to new Agentflare features and direct support from the Agentflare team.
...
**In Agentflare:** The migration guide assists teams in adopting Agentflare Agentflare with minimal disruption to existing workflows.
...
**In Agentflare:** Agentflare provides comprehensive observability for AI agents, including thought processes, tool usage, performance metrics, and cost data.

**See also:** [Agentflare](#telepathy), [Thought Tracing](#thought-tracing)
...
**In Agentflare:** WebSocket connections enable real-time streaming of agent thoughts and tool calls to the Agentflare dashboard.
