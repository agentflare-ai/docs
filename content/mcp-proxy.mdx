...
const client = new Client({
  transport: new HTTPTransport({
    baseUrl: "https://<your-server-slug>.proxy.agentflare.com",
    headers: {
...
<Steps>
  ...
  <Step title="Copy Proxy URL">
    Copy your unique proxy URL: `https://<your-server-slug>.proxy.agentflare.com`
  </Step>
...
client = Client(
    transport=HTTPTransport(
        base_url="https://<your-server-slug>.proxy.agentflare.com",
        headers={
...
curl -H "Authorization: Bearer <your-api-key>" \
     https://<your-server-slug>.proxy.agentflare.com/health
...
curl -X POST \
     ...
     -d '{"method": "tools/list"}' \
     https://<your-server-slug>.proxy.agentflare.com/rpc
```
